...
const LightStripItem = styled.li<LightStripItemProps>(props => {
    ...
    return css`
      ...
      box-shadow: 0 ${ globeHeight / 6 }px ${ globeWidth * 2 }px ${ globeSpread }px rgba(${ rgbColor });
      ...
      @keyframes flash-${ rgbColor.replaceAll(',', '-') } {
        ...
        50% {
          ...
          box-shadow: 0 ${ globeHeight / 6 }px ${ globeWidth * 2}px ${ globeSpread }px rgba(${ rgbColor }, 0.2);
        }
      }
    `
});
