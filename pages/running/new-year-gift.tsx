...
const NewYearGift: NextPage = () => {
    ...
    //     })
    //
    //     let getSVGPoints = (path: string) => {
    //         const arr: { x: number, y: number }[] = [];
    //         const rawPath = MotionPathPlugin.getRawPath(path)[0];
    //         rawPath.forEach((el: any, value: number) => {
    //             let obj = { x: 0, y: 0 };
    ...
    //     let starTl = gsap.timeline({delay:0, repeat:0});;
    //
    //     function flicker(p: any) {
    //
    ...
    return (
        <div>
            ...
            <main>
                ...
                <svg style={{   width:'90%',
                    height:'90%',
                    visibility:'hidden'}} className="mainSVG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600">
                    <defs>
